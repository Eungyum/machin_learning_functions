...
def grid_search(x_train, y_train, fitted_model, n, params=None):
    
    params=params
    
    grid_model = GridSearchCV(fitted_model, param_grid=params, cv=n, refit=True)
    ...
    #  grid_model 평가
    classify_eval(x_test, y_test, grid_model)
